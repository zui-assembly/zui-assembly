...
import { Checkbox, CheckboxGroup } from '@zui-assembly/components/checkbox';
...
const pulgins = [Icon, Button, ButtonGroup, Link, Checkbox, CheckboxGroup, Calendar, VirtualScrollList];
